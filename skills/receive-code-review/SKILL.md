...
allowed-tools: Bash, Write, Edit, AskUserQuestion, Read, Grep, Skill(write-commit), Skill(verification-before-completion), Skill(diagnose), Skill(request-code-review), Skill(pr-workflow)
---
